      ...
      content: (
        subSection(
          content: [
              ...
              Data Scientist and AI Engineer with a Ph.D. in Physics and 10+ years of research and applied experience, including 4 years in industry, specializing in statistical modeling, machine learning, and data-driven solutions for forecasting, demand calculation, and pricing analysis. Proficient in extracting and cleaning data from databases like PostgreSQL and MariaDB using Python (pandas, NumPy, Scikit-learn) and SQL to analyze user behavior, market patterns, and e-commerce dynamics. Experienced in building, testing, and tracking model performance against business outcomes with metrics like Precision, Recall, F1, MAE, and AUROC, while deploying scalable solutions via MLOps tools for real-world impact in fast-paced teams.
      ...
      content: (
        subSection(
          content: [
            ...
            *Data Science & Machine Learning*: Supervised and unsupervised learning, quantitative approaches, advanced statistical methods, data mining techniques, information retrieval, feature engineering, pattern recognition, predictive modeling, anomaly detection, time series forecasting, evaluation metrics, and experimentation. Tools: Scikit-learn, XGBoost, LightGBM, Spark, Airflow, Statistical Modeling, Sales Forecasting, Demand Calculation, Pricing Strategy Analysis, Data Extraction and Cleaning, PostgreSQL, MariaDB, User Behavior Analysis, Market Pattern Identification, Model Performance Tracking, Python (Pandas, NumPy, Scikit-learn), SQL, Time Series Forecasting, Anomaly Detection, MLOps (Docker, MLflow, CI/CD) .\ 
