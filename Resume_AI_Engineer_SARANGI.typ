      ...
      content: (
        subSection(
          content: [
               ...
               AI/ML Engineer & LLM Specialist with 10+ years of research and applied data science experience and a Ph.D. in Physics. Expert in designing, developing, and implementing AI solutions using Machine Learning, Computer Vision, Generative AI, and Chatbots to enhance operations, management efficiency, and business workflows. Combines deep scientific rigor with practical AI deployment—specializing in *domain-specific small-language model (SLM) optimization, RAG-systems,* Vision-Language Model (VLM) integration, and end-to-end AI system architecture. Proven track record of translating complex research into scalable, production-ready solutions, including internal AI tools for design assistance, prediction, project management, and automated document processing, across industry and academic collaborations.
          ]
        )
      )
    ),
