          ...
          content: [
            *Projects & Technical Experience*
            #list(
              ...
              [Designed and deployed end-to-end supervised learning pipelines (Random Forest, XGBoost, Gradient Boosting, logistic regression) for clinical prediction tasks, achieving 87% sensitivity and >99% Laspecificity on imbalanced biomedical datasets.],
