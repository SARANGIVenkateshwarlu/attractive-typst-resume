...
main: (
    ...
    section(
      ...
      content: (
        subSection(
          title: "Research Associate (Bioelectrod materials and Data Analysis)",
          titleEnd: "CityU HK & HKUST & Gense Technologies Ltd, HK",
          subTitleEnd: "(2022 – Aug, 2025)",
          content: [
            *Fabrication Dry electrodes & Data analysis for Biomedical Impedance Data*
            #list(
              [Designed and developed novel dry electrodes and Keen phantom prototypes, integrating them with real-case and 2D-3D EIT imaging systems to enhance acquisition accuracy.],
              ...
              [Implemented linear, polynomial, and nonlinear regression models for predictive analytics and pattern extraction across biomedical datasets.],
              [Built and validated algorithmic modeling pipelines for biomedical impedance data, boosting EIT image reconstruction accuracy.],
              [Applied signal processing, regression modeling, and statistical optimization to improve data reliability and prediction quality.],
              [Technologies: Python, NumPy, Scikit‑learn, Pandas, SQL, Power BI, Tableau, Impedance Analyzer]
            )
          ],
        ),
        subSection(
